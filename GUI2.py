...
def abrir_graficos():
    ...
    graph_window.title("Gráficos de Gas")
    graph_window.geometry("800x600")
    graph_window.configure(bg="#1E3D59")
    
    # =================== TÍTULO ===================
    title_label = tk.Label(graph_window, text="Porcentaje de Gas Variante al Tiempo", font=("Arial", 18, "bold"), bg="#1E3D59", fg="white")
...
# =================== BOTÓN ===================
connect_button = tk.Button(container, text="Conectar", bg="#2599D2", fg="white", font=("Arial", 14), width=20, command=abrir_graficos)
